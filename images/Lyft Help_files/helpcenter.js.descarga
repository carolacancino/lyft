...
var _                   = require("underscore"),
    ConditionChecker    = require("../lib/condition_checker")(_),
    dispatchChangeEvent = require("../lib/change_event");

$(document).ready(function() {
  var allValidConditions = ConditionChecker.getAllValidConditions(cfaRules);
  ...
  function cfaApplyRules() {
    ...
    var requiredFieldsMissing = _.any(requiredIds, function(id) {
      return $ticketFieldForID(id).is(':visible') && !fieldValueForID(id);
    });
...
},{"../lib/change_event":1,"../lib/condition_checker":2,"underscore":3}]},{},[4]);
